...
class Ui_FarmView(object):
    def setupUi(self, FarmView):
        ...
        self.gridLayout_7.addWidget(self.testFramesButton, 1, 7, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.editJobButton, 2, 0, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.filterJobButton, 2, 3, 1, 1)
        self.doNothingJobButton = QtGui.QPushButton(self.groupBox_jobOptions)
        self.doNothingJobButton.setObjectName(_fromUtf8("doNothingJobButton"))
        self.gridLayout_7.addWidget(self.doNothingJobButton, 2, 5, 1, 1)
        ...
        self.gridLayout_9.addWidget(self.editTaskButton, 3, 1, 1, 1)
        ...
        self.gridLayout_9.addWidget(self.killTaskButton, 2, 1, 1, 1)
        ...
        self.gridLayout_9.addWidget(self.resetTaskButton, 3, 3, 1, 1)
        self.doNothingTaskButton = QtGui.QPushButton(self.groupBox_subTaskOptions)
        self.doNothingTaskButton.setObjectName(_fromUtf8("doNothingTaskButton"))
        self.gridLayout_9.addWidget(self.doNothingTaskButton, 2, 3, 1, 1)
    ...
    def retranslateUi(self, FarmView):
        ...
        self.resetJobButton.setText(_translate("FarmView", "Reset", None))
        self.killJobButton.setText(_translate("FarmView", "Kill", None))
        self.editJobButton.setText(_translate("FarmView", "Edit...", None))
        self.filterJobButton.setText(_translate("FarmView", "Filters...", None))
        self.doNothingJobButton.setText(_translate("FarmView", "Do Nothing", None))
        ...
        self.editTaskButton.setText(_translate("FarmView", "Edit...", None))
        ...
        self.doNothingTaskButton.setText(_translate("FarmView", "Do Nothing", None))
