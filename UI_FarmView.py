...
class Ui_FarmView(object):
    def setupUi(self, FarmView):
        ...
        self.showArchivedCheckbox = QtGui.QCheckBox(self.groupBox_jobOptions)
        font = QtGui.QFont()
        font.setPointSize(8)
        self.showArchivedCheckbox.setFont(font)
        self.showArchivedCheckbox.setObjectName(_fromUtf8("showArchivedCheckbox"))
        self.gridLayout_7.addWidget(self.showArchivedCheckbox, 2, 10, 1, 1)
        self.filterJobButton = QtGui.QPushButton(self.groupBox_jobOptions)
        self.filterJobButton.setEnabled(True)
        ...
        self.toggleArchiveButton = QtGui.QPushButton(self.groupBox_jobOptions)
        self.toggleArchiveButton.setObjectName(_fromUtf8("toggleArchiveButton"))
        self.gridLayout_7.addWidget(self.toggleArchiveButton, 1, 10, 1, 1)
    ...
    def retranslateUi(self, FarmView):
        ...
        self.showArchivedCheckbox.setText(_translate("FarmView", "Show Archived", None))
        ...
        self.toggleArchiveButton.setText(_translate("FarmView", "Toggle Archive", None))
