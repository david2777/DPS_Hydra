...
class Ui_FarmView(object):
    def setupUi(self, FarmView):
        ...
        self.gridLayout_7.addWidget(self.testFramesButton, 2, 2, 1, 1)
        ...
        self.gridLayout_9.addWidget(self.pauseTaskButton, 1, 1, 1, 1)
    ...
    def retranslateUi(self, FarmView):
        ...
        self.pauseTaskButton.setText(_translate("FarmView", "Pause", None))
