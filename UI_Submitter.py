...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.formLayout_3.setWidget(0, QtGui.QFormLayout.LabelRole, self.sceneLabel)
        ...
        self.formLayout_3.setLayout(0, QtGui.QFormLayout.FieldRole, self.sceneLayout)
        self.projLabel = QtGui.QLabel(self.tab_2)
        self.projLabel.setObjectName(_fromUtf8("projLabel"))
        self.formLayout_3.setWidget(2, QtGui.QFormLayout.LabelRole, self.projLabel)
        ...
        self.formLayout_3.setLayout(2, QtGui.QFormLayout.FieldRole, self.mayaProjLayout)
        self.priorityLabel = QtGui.QLabel(self.tab_2)
        self.priorityLabel.setObjectName(_fromUtf8("priorityLabel"))
        self.formLayout_3.setWidget(6, QtGui.QFormLayout.LabelRole, self.priorityLabel)
        ...
        self.formLayout_3.setWidget(6, QtGui.QFormLayout.FieldRole, self.prioritySpinBox)
        self.executableLabel = QtGui.QLabel(self.tab_2)
        self.executableLabel.setObjectName(_fromUtf8("executableLabel"))
        self.formLayout_3.setWidget(7, QtGui.QFormLayout.LabelRole, self.executableLabel)
        self.executableComboBox = QtGui.QComboBox(self.tab_2)
        self.executableComboBox.setObjectName(_fromUtf8("executableComboBox"))
        self.formLayout_3.setWidget(7, QtGui.QFormLayout.FieldRole, self.executableComboBox)
        self.cmdLabel = QtGui.QLabel(self.tab_2)
        self.cmdLabel.setObjectName(_fromUtf8("cmdLabel"))
        self.formLayout_3.setWidget(8, QtGui.QFormLayout.LabelRole, self.cmdLabel)
        ...
        self.formLayout_3.setWidget(8, QtGui.QFormLayout.FieldRole, self.cmdLineEdit)
        self.testNodesLabel = QtGui.QLabel(self.tab_2)
        self.testNodesLabel.setObjectName(_fromUtf8("testNodesLabel"))
        self.formLayout_3.setWidget(9, QtGui.QFormLayout.LabelRole, self.testNodesLabel)
        ...
        self.formLayout_3.setWidget(9, QtGui.QFormLayout.FieldRole, self.testNodesSpinBox)
        self.line = QtGui.QFrame(self.tab_2)
        self.line.setFrameShape(QtGui.QFrame.HLine)
        self.line.setFrameShadow(QtGui.QFrame.Sunken)
        self.line.setObjectName(_fromUtf8("line"))
        self.formLayout_3.setWidget(5, QtGui.QFormLayout.SpanningRole, self.line)
