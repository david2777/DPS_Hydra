...
class Ui_FarmView(object):
    def setupUi(self, FarmView):
        ...
        self.taskTable.setEditTriggers(QtGui.QAbstractItemView.DoubleClicked|QtGui.QAbstractItemView.EditKeyPressed)
        ...
        self.taskTable.setColumnCount(12)
        ...
        self.renderNodeTable.setEditTriggers(QtGui.QAbstractItemView.DoubleClicked|QtGui.QAbstractItemView.EditKeyPressed)
    ...
    def retranslateUi(self, FarmView):
        ...
        item.setText(_translate("FarmView", "Start", None))
        item = self.taskTable.horizontalHeaderItem(2)
        item.setText(_translate("FarmView", "End", None))
        ...
        item.setText(_translate("FarmView", "Attempts", None))
        ...
        item.setText(_translate("FarmView", "ScheduleEnabled", None))
