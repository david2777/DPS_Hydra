...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setTabOrder(self.tabWidget, self.niceNameLineEdit)
        MainWindow.setTabOrder(self.niceNameLineEdit, self.renderLayersLineEdit)
        ...
        MainWindow.setTabOrder(self.finalCheckBox, self.autocompCheckBox)
        MainWindow.setTabOrder(self.autocompCheckBox, self.legoLayersCheckBox)
        MainWindow.setTabOrder(self.legoLayersCheckBox, self.sceneButton)
        MainWindow.setTabOrder(self.sceneButton, self.sceneLineEdit)
        MainWindow.setTabOrder(self.sceneLineEdit, self.projButton)
        MainWindow.setTabOrder(self.projButton, self.projLineEdit)
        MainWindow.setTabOrder(self.projLineEdit, self.startStatusRadioButton)
        ...
        MainWindow.setTabOrder(self.prioritySpinBox, self.executableComboBox)
        MainWindow.setTabOrder(self.executableComboBox, self.cmdLineEdit)
        MainWindow.setTabOrder(self.cmdLineEdit, self.testNodesP1SpinBox)
        MainWindow.setTabOrder(self.testNodesP1SpinBox, self.testNodesP2SpinBox)
        MainWindow.setTabOrder(self.testNodesP2SpinBox, self.submitButton)
