...
class Ui_RenderNodeMainWindow(object):
    def setupUi(self, RenderNodeMainWindow):
        ...
        self.runCmdButton = QtGui.QPushButton(self.MainGroup)
        self.runCmdButton.setObjectName(_fromUtf8("runCmdButton"))
        self.horizontalLayout_6.addWidget(self.runCmdButton)
        ...
        self.weekSchedule = QtGui.QLabel(self.MainGroup)
        ...
        self.scheduleEnabled_LABEL = QtGui.QLabel(self.MainGroup)
        self.scheduleEnabled_LABEL.setObjectName(_fromUtf8("scheduleEnabled_LABEL"))
        self.formLayout_thisNodeLabels.setWidget(7, QtGui.QFormLayout.LabelRole, self.scheduleEnabled_LABEL)
    ...
    def retranslateUi(self, RenderNodeMainWindow):
        ...
        self.runCmdButton.setText(_translate("RenderNodeMainWindow", "Run CMD...", None))
        ...
        self.weekSchedule.setText(_translate("RenderNodeMainWindow", "N/A", None))
        self.scheduleEnabled_LABEL.setText(_translate("RenderNodeMainWindow", "Week Schedule:", None))
