...
class Ui_taskResetDialog(object):
    def setupUi(self, taskResetDialog):
        ...
        taskResetDialog.resize(362, 320)
        ...
        self.formLayout_2.setWidget(2, QtGui.QFormLayout.SpanningRole, self.renderLayerListWidget)
        ...
        self.formLayout_2.setLayout(5, QtGui.QFormLayout.FieldRole, self.buttonLayout)
        ...
        self.formLayout_2.setWidget(3, QtGui.QFormLayout.FieldRole, self.startFrameSpinbox)
        self.frameRangeLabel = QtGui.QLabel(taskResetDialog)
        self.frameRangeLabel.setObjectName(_fromUtf8("frameRangeLabel"))
        self.formLayout_2.setWidget(3, QtGui.QFormLayout.LabelRole, self.frameRangeLabel)
        ...
        self.formLayout_2.setWidget(4, QtGui.QFormLayout.FieldRole, self.resetNodeCheckbox)
        self.renderLayersCheckbox = QtGui.QCheckBox(taskResetDialog)
        self.renderLayersCheckbox.setChecked(True)
        self.renderLayersCheckbox.setObjectName(_fromUtf8("renderLayersCheckbox"))
        self.formLayout_2.setWidget(1, QtGui.QFormLayout.LabelRole, self.renderLayersCheckbox)
    ...
    def retranslateUi(self, taskResetDialog):
        ...
        self.renderLayersCheckbox.setText(_translate("taskResetDialog", "Render Layers:", None))
