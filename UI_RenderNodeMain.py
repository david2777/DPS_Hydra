...
class Ui_RenderNodeMainWindow(object):
    def setupUi(self, RenderNodeMainWindow):
        ...
        RenderNodeMainWindow.resize(800, 702)
        ...
        self.formLayout_2.setLayout(4, QtGui.QFormLayout.SpanningRole, self.buttonLayout)
        self.outputLabel = QtGui.QLabel(self.MainGroup)
        self.outputLabel.setObjectName(_fromUtf8("outputLabel"))
        self.formLayout_2.setWidget(5, QtGui.QFormLayout.LabelRole, self.outputLabel)
        ...
        self.formLayout_2.setWidget(6, QtGui.QFormLayout.SpanningRole, self.outputTextEdit)
        ...
        self.formLayout_2.setLayout(3, QtGui.QFormLayout.SpanningRole, self.horizontalLayout_6)
