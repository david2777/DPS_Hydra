...
class Ui_nodeSchedulerDialog(object):
    def setupUi(self, nodeSchedulerDialog):
        ...
        nodeSchedulerDialog.resize(1073, 335)
        ...
        nodeSchedulerDialog.setMinimumSize(QtCore.QSize(1073, 335))
        nodeSchedulerDialog.setMaximumSize(QtCore.QSize(1073, 335))
        ...
        self.scheduleTable.setMinimumSize(QtCore.QSize(0, 0))
        self.scheduleTable.setMaximumSize(QtCore.QSize(1034, 226))
        ...
        self.scheduleTable.horizontalHeader().setHighlightSections(False)
        self.scheduleTable.verticalHeader().setHighlightSections(False)
